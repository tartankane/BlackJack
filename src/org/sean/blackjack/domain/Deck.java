 ...
 * The 52 cards are stored in a List<Card>. When a random card is dealt from the
 * deck, then that card is removed from the List<Card>.
 * 
 */
public class Deck {
	...
	/**
	 * Randomly selects a card from the remaining cards in the deck. This card is 
	 * removed from the deck and returned by the method.
	 * @return Card
	 */
	 ...
	 * For the full deck of cards, set min = 0 and max = 51 to generate a random int
	 * from 52 possible values.
	 * @param min normally set to zero
	 * @param max normally set to "size of the deck minus one"
	 * @return
	 */
